...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief" style="width: 950px; margin: auto">
    <ul class="layui-tab-title">
        <li class="layui-this"><a href="/homepage" style="text-decoration:none; font-size: 15px">所有商品</a></li>
        <c:forEach items="${typeall}" var="type">
            <li><a class="comm-type" id="${type.typesid}"
                   style="text-decoration:none; font-size: 15px">${type.typestext}</a>
            </li>
        </c:forEach>
    </ul>
</div>
