...
<h3 style="margin-left: 30px; margin-top: 10px">发布公告</h3>
<hr>

<div style="width: 700px; height: auto; margin: auto; margin-top: 30px;">

    <form action="/insertAnnouncement" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>详情：</label>
            <textarea class="form-control" id="exampleFormControlTextarea4" name="onticetext" style="height: 250px; resize: vertical;" placeholder="请输入"></textarea>
        </div>
